		...
		<div class="block clearfix">
			...
			<nav>
				<ul class="nav nav-pills nav-stacked">
					<li class="active_bar" id="my_resume"><a href="myRecruit.do"><img src="frontjsp/assets/images/resume.png" style="float:left;" />&nbsp;简历信息</a></li>
					<li class="active_bar" id="my_apply"><a href="myApply.do"><img src="frontjsp/assets/images/yingpin.png" style="float:left;" />&nbsp;应聘信息</a></li>
					<li class="active_bar" id="my_account"><a href="myAccount.do"><img src="frontjsp/assets/images/account.png" style="float:left;" />&nbsp;账户信息</a></li>
					<li class="active_bar" id="my_question"><a href="myQuestion.do"><img src="frontjsp/assets/images/liuyanban.png" style="float:left;" />&nbsp;我的留言</a></li>
				</ul>
			</nav>
		</div>
	</div>
	...
	<div class="tabs-style-2">
		...
		<div class="tab-content">
			<table class="table table-striped">
				...
				<tbody>
				<form id="myApply152689" name="myApply" method="post" do="cancel.do?recordId=152689">
