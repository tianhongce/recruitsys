...
//		    }
        ...
        {
            var options = {text : message, type : 'loading', stayTime : typeof(timeout) != "undefined" ? timeout : settings.stayTime};
			$(".toast-item-wrapper").remove();
            return $().toastmessage('showToast', options);
        },

        showNoticeToast : function (message, timeout)
        {
            var options = {text : message, type : 'notice', stayTime : typeof(timeout) != "undefined" ? timeout : settings.stayTime};
			$(".toast-item-wrapper").remove();
            return $().toastmessage('showToast', options);
        },

        showSuccessToast : function (message, timeout)
        {
            var options = {text : message, type : 'success', stayTime : typeof(timeout) != "undefined" ? timeout : settings.stayTime};
			$(".toast-item-wrapper").remove();
            return $().toastmessage('showToast', options);
        },

        showErrorToast : function (message, timeout)
        {
            var options = {text : message, type : 'error', stayTime : typeof(timeout) != "undefined" ? timeout : settings.stayTime};
			$(".toast-item-wrapper").remove();
            return $().toastmessage('showToast', options);
        },

        showWarningToast : function (message, timeout)
        {
            var options = {text : message, type : 'warning', stayTime : typeof(timeout) != "undefined" ? timeout : settings.stayTime};
			$(".toast-item-wrapper").remove();
            return $().toastmessage('showToast', options);
        },
